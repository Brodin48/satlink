...
export default function SAIPTVActivationSmartTVPage() {
  return (
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Enter Activation Code</h3>
                    <p className="text-gray-600">Open the app and enter your unique activation code provided in your subscription email.</p>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Need Your Activation Code?</h3>
              <p className="text-gray-600 mb-4">
                Your activation code was sent to your email after purchase. Can't find it?
              </p>
              <a 
                href="/contact" 
