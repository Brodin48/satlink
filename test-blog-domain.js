...
async function testBlogDomain() {
  console.log('🔍 Testing blog.iptvsatlink.com...\n')
  ...
  try {
    ...
    const http = execSync('curl -I -m 10 https://blog.iptvsatlink.com', { encoding: 'utf8' })
  ...
  try {
    ...
    const api = execSync('curl -I -m 10 https://blog.iptvsatlink.com/wp-json/wp/v2/posts', { encoding: 'utf8' })
  ...
  console.log('\n📋 Summary:')
  console.log('- Domain: blog.iptvsatlink.com')
  console.log('- Expected API: https://blog.iptvsatlink.com/wp-json/wp/v2/posts')
